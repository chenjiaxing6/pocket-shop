...
<div id="header">
    <div class="header-box">
        <h3 class="huany">口袋商城本地购物商城欢迎您的到来！</h3>
        ...
        <ul class="header-right">
            <c:if test="${LoginUser != null}">
                <li class="denglu">欢迎您~<a class="red" href="#"></a>${LoginUser.username}  <a class="red" href="/logout">[注销]</a></li>
            </c:if>
            <c:if test="${LoginUser == null}">
            ...
            <li class="shu"></li>
            <li class="shouji bj">
                <a class="ing_ps ps3" href="#">手机口袋商城</a>
                <i class="ci-right ">
                    <s class="jt">◇</s>
                </i>
                <div class="shouji1">
                    ...
                    <div class="yi">
                        ...
                        <div class="er">
                            <p>口袋商城微信公众号</p>
                            <p class="red">关注口袋商城公众号的积分，换大礼</p>
                        </div>
                    </div>
                </div>
            </li>
...
<div id="lunbo">
    ...
    <ul id="two">
        <c:forEach items="${ppt}" var="p" varStatus="p1">
            <li class=${p1.count == 1?"on":""}>${p1.count}</li>
        </c:forEach>
    </ul>
    <!--轮播图左右箭头-->
